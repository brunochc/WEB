  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Ubicación',
      content: 'Av. Principal 1234, Ciudad',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              ...
              <p className="text-xl font-bold text-red-400">+56 9 8765 4321</p>
            </motion.div>

            {/* Map Placeholder */}
            <motion.div
              className="bg-gray-800 rounded-xl h-64 flex items-center justify-center border border-gray-700"
              whileHover={{ scale: 1.02 }}
            >
